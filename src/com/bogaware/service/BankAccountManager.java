...
public class BankAccountManager {
	...
	public BankAccountManager(int userId, int institutionLinkId, String accessToken) {
		...
		plaidClient = PlaidClient.newBuilder()
				  .clientIdAndSecret(SettingsManager.properties.getProperty("PLAID_CLIENT_ID"), SettingsManager.properties.getProperty("PLAID_SECRET"))
				  .publicKey(SettingsManager.properties.getProperty("PLAID_PUBLIC_KEY")) 
				  .developmentBaseUrl() 
				  .build();
	}
	...
	private String getLinkSessionId() {
		...
		requestJson.put("public_key", SettingsManager.properties.getProperty("PLAID_PUBLIC_KEY"));
		String response = Functions.callPost("https://" + SettingsManager.properties.getProperty("PLAID_ENV") + "/link/client/get", requestJson.toJSONString(), null, null);
	...
	private String getPublicToken(String linkSessionId, int instit, String user, String pass) {
		...
		requestJson.put("public_key", SettingsManager.properties.getProperty("PLAID_PUBLIC_KEY"));
		String response = Functions.callPost("https://" + SettingsManager.properties.getProperty("PLAID_ENV") + "/link/item/create", requestJson.toJSONString(), null, null);
		JSONObject jsonReponse = RestManager.stringToJson(response);
